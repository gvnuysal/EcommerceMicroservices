...
namespace Teknosol.Services.Discount.Services
{
    public class DiscountService : IDiscountService
    {
        ...
        public virtual async Task<Response<List<Models.Discount>>> GetAllAsync()
        {
            var discounts = await _dbConnection.QueryAsync<Models.Discount>("select *from discount");
            return Response<List<Models.Discount>>.Success(discounts.ToList(), 200, discounts.Count());
        }

        public virtual async Task<Response<Models.Discount>> GetByIdAsync(int id)
        {
        ...
        public virtual async Task<Response<NoContent>> SaveAsync(Models.Discount discount)
        {
            var saveStatus = await _dbConnection.ExecuteAsync("INSERT INTO discount(userid,rate,code) values(@UserId,@Rate,@Code)", new
            {
        ...
        public virtual async Task<Response<NoContent>> UpdateAsync(Models.Discount discount)
        {
        ...
        public virtual async Task<Response<Models.Discount>> GetByCodeAndUserIdAsync(string code, string userId)
        {
